export const products = [
  {
    ...
    description:
      'PP Woven Fabric Rolls are made from 100% virgin polypropylene and are available in circular (tubular) or flat (loomcut) types. They are highly customizable for width, GSM, color, weave, and more, making them ideal for bag manufacturing, wrapping, pallet covering, and ground sheeting.',
    ...
    specifications: {
      ...
      colorOptions:
        'White / Cream / Gray / Black / As per customer requirement',
      ...
      lamination:
        'Without Lamination / With BOPP or LDPE Coating (Single or Double Side)',
      printing: 'Optional Flexographic Printing (Single or Multicolor)',
      packing: 'Rolls packed with HDPE/PP sheet or Stretch Film',
      usage:
        'Bag manufacturing, Wrapping material, Pallet covering, Ground sheeting',
    },
    applications: [
      'Bag manufacturing',
      'Wrapping material',
    ...
    longDescription:
      'PP Woven Fabric Rolls are versatile and durable, suitable for a variety of industrial, agricultural, and construction applications. They can be tailored to meet specific requirements for strength, color, and protection, ensuring reliable performance in demanding environments.',
  },
  {
    id: 'anti-slip-bag',
    name: 'Anti Slip Bag',
    ...
    description:
      'Designed with a textured or coated surface, PP Woven Anti-Slip Bags offer enhanced stacking stability, preventing slippage during transportation or storage. The special anti-skid coating reduces shifting on pallets, making these bags ideal for cement, grains, fertilizers, and other bulk materials.',
    ...
    longDescription:
      'Their heavy-duty strength combined with safety-focused surface treatment makes them a preferred choice in logistics and industrial packaging.',
  },
  {
    id: 'sugar-bag',
    name: 'Sugar Bag',
    ...
    description:
      'Made from food-grade polypropylene, PP Woven Sugar Bags ensure safe and hygienic packaging for refined and raw sugar. These bags may come with or without liners and are optimized to protect contents from moisture and contamination.',
    ...
    longDescription:
      'They offer excellent printability for branding, while strong stitching ensures secure closure and handling across long distances.',
  },
  {
    id: 'transparent-bag',
    ...
    description:
      'PP Woven Transparent Bags are made from clear woven polypropylene, allowing product visibility without compromising strength. Ideal for grains, seeds, plastics, and similar items, these bags combine transparency with robust protection.',
    ...
    longDescription:
      'Optional printing and custom sizing make them perfect for branded retail packaging while offering functional benefits like ventilation and durability.',
  },
  {
  ...
  },
  {
    ...
    description:
      'PP Woven W-Cut Bags are strong, reusable shopping bags with a soft, seamless handle cut in a "W" shape. Ideal for retail, grocery, and promotional use, they offer an eco-friendly alternative to plastic carry bags.',
    ...
    longDescription:
      'Lightweight and printable, W-Cut bags are both stylish and practical for daily consumer use.',
  },
  {
    id: 'cattlefeed-bag',
    name: 'Cattlefeed Bag',
    ...
    description:
      'PP Woven Cattle Feed Bags are designed for packaging animal feed, including poultry, cattle, and fish feed. With vibrant printing and lamination options, these bags not only protect the feed but also support brand visibility in retail environments.',
    ...
    longDescription:
      'Their superior barrier properties and robust structure make them ideal for rough handling and long storage durations.',
  },
  {
    id: 'salt-bag',
    name: 'Salt Bag',
    ...
    description:
      'PP Woven Salt Bags are moisture-resistant, durable, and food-safe — ideal for packaging edible or industrial salt. Available with liners or lamination, these bags ensure salt remains dry and clump-free.',
    category: 'Food Packaging',
    specifications: {
    ...
    longDescription:
      'Flexographic printing and tight stitching provide a clean, professional finish for both domestic and export packaging.',
  },
  {
    id: 'plain-bag',
    name: 'Plain Bag',
    ...
    specifications: {
      ...
      color: 'White / Cream / Gray / Black / As requested',
  ...
  },
  {
    ...
    description:
      'PP Woven Cement Bags are designed to handle the heavy-duty requirements of cement packaging. These bags offer high tensile strength, moisture resistance, and anti-slip properties. Available in open-mouth or valve-type variants, they are compatible with both manual and automatic filling systems.',
    ...
    longDescription:
      'Built to withstand tough handling conditions, these bags protect cement and other construction materials during transportation and storage.',
  },
  {
    id: 'gusseted-bag',
    name: 'Gusseted Bag',
    ...
    description:
      'PP Woven Gusseted Bags are specially designed to maximize storage space and improve stacking efficiency. With gussets on either side or at the bottom, these bags expand to accommodate more volume, making them ideal for bulky or irregularly shaped products.',
    category: 'Premium Packaging',
    specifications: {
  ...
  },
  {
    ...
    description:
      'PP Woven D-Cut Bags feature a die-cut handle, giving them a sleek, premium look for retail and fashion packaging. Available in laminated glossy or matte finishes, they support bold brand printing and offer excellent durability for repeat use.',
    category: 'Retail Packaging',
    specifications: {
    ...
    longDescription:
      'These bags combine functionality with aesthetics, making them a preferred choice for promotional and luxury packaging.',
  },
  {
    id: 'fertilizer-bag',
    name: 'Fertilizer Bag',
    ...
    description:
      'PP Woven Fertilizer Bags are tailored to withstand the reactive nature of fertilizers. They can be customized with liners, UV protection, lamination, and multicolor BOPP prints for premium branding. These bags prevent leakage, provide durability, and allow for secure handling.',
    category: 'Agricultural Packaging',
    specifications: {
    ...
    longDescription:
      'Widely used in the agricultural sector, they offer excellent resistance to tearing and chemical damage.',
  },
  {
    id: 'valve-type-bag',
    name: 'Valve Type Bag',
    ...
    description:
      'PP Woven Valve Type Bags are innovative packaging solutions commonly used in automated filling systems. These bags feature a valve opening that enables fast filling without the need for manual sealing. Once filled, the valve automatically seals under pressure, ensuring spill-proof storage.',
    category: 'Specialty Packaging',
    specifications: {
    ...
    longDescription:
      'Often used in cement, building materials, and chemical industries, valve-type bags improve operational efficiency and reduce product loss.',
  },
  {
    ...
    description:
      'PP Woven Liner Inserted Bags feature an inner liner of LDPE or LLDPE, providing superior protection against moisture, air, and contamination. These bags are particularly suitable for packaging fine powders, chemicals, sugar, flour, and other materials that require a secure, leak-proof environment.',
    category: 'Premium Packaging',
    specifications: {
    ...
    longDescription:
      'The inner liner can be loose or bottom-sealed and stitched into the outer woven layer. Ideal for hygienic and moisture-sensitive packaging, these bags ensure your products are stored and transported safely.',
  },
  {
    id: 'fibc-jumbo-bag',
    name: 'FIBC/Jumbo Bag',
    ...
    specifications: {
      material: '100% Virgin Polypropylene (PP)',
      bagTypes:
        'U-Panel, Circular, 4-Panel, Baffle (Q Bags), Conductive Bags (Type B, C, D)',
      ...
      liftingOptions:
        'Cross Corner Loops / Side Seam Loops / Sleeve Lift / Stevedore Straps',
      topOptions: 'Open Top / Duffle Top / Spout Top / Cone Top',
      bottomOptions:
        'Flat Bottom / Discharge Spout / Duffle Bottom / Conical Bottom',
      linerOption: 'With or Without PE Liner (Gusseted / Tubular / Form-Fit)',
      printing: 'Up to 3 Colors on 2 Sides (Flexographic Printing)',
      dustproofSeams:
        'Optional: Single, Double or Triple Stitched with filler cord',
      certifications: 'ISO 9001:2015 / ISO 21898 / UN Certified (on request)',
      usage:
        'Bulk storage and transport of Cement, Fertilizer, Grain, Sand, Chemicals',
    },
    applications: [
