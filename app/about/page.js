'use client';
import logo from '../../public/solar_image.jpeg';
  ...
  return (
    <Container maxWidth="xl" sx={{ py: { xs: 6, md: 8 } }}>
      ...
      >
        ...
        >
          Sustainable Solar-Powered Manufacturing At Lavish Polypack LLP, we believe that great packaging should come with great responsibility. Our entire manufacturing facility operates on clean, renewable energy generated by our own solar power plant. By harnessing the power of the sun, we significantly reduce our carbon footprint, minimize reliance on non-renewable resources, and ensure an eco-friendly production process. This commitment to sustainability not only helps protect the environment but also delivers high-quality PP woven packaging solutions with a conscience — packaging that’s as responsible as it is reliable.</Typography>
      </Box>
      ...
      >
           <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
            <Building2 size={28} style={{ marginRight: 12, color: "#8B4513" }} />
            <Typography
              variant="h4"
              component="h3"
              sx={{
